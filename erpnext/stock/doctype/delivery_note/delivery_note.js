...
frappe.ui.form.on("Delivery Note", {
	...
	item_for_batch:function(frm){
		debugger
		frm.clear_table("itemwise_batch_details")
		frm.refresh_field("itemwise_batch_details")
		if(frm.doc.item_for_batch != null)
		{
		frm.call	({
			method:"list_all_Batches",
			doc:frm.doc,
			args:{
				doctype:"Batch",
				item:frm.doc.item_for_batch,
				filters:
				{
					"item": frm.doc.item_for_batch,
		...
		frappe.msgprint("Please Select the Item")
		}
	},
	// get_batch_details:function(frm, cdt, cdn){
	// 	debugger
	// 	const table1Data = frm.doc.items ;

    // // Get the second table's data
    // const table2Data = frm.doc.itemwise_batch_details || [];

    // // Filter out matching rows from table1
    // const filteredTable1Data = table1Data.filter(row1 => {
    //   const matchingRow = table2Data.find(row2 => row1.item_code === row2.item);
    //   return !matchingRow;
    // });

    // // Filter out matching rows from table2
    // const filteredTable2Data = table2Data.filter(row1 => {
    //   const matchingRow = table1Data.find(row2 => row1.item_code === row2.item);
    //   return !matchingRow;
    // });
    // // Update the tables' data
    // frm.set_value('items', filteredTable1Data);
	// 	frm.call	({
	// 		method:"Batch_selector",
	// 		doc:frm.doc,
	// 		args:{
	// 			doctype:"Batch",
	// 			item:frm.doc.item_for_batch,
	...
	// 	frm.doc.item_for_batch = ''
	// },
	// get_batch_items:function(frm, cdt, cdn){
	// 	debugger
	// 	frm.clear_table("itemwise_batch_details")
	// 	frm.refresh_field("itemwise_batch_details")
	// 	var sales_order_item = [];
	// 	var sales_order_code;
	// 	var table = frm.fields_dict['items'].grid;
    //     var rowIndex = 0; // For example, remove the first row
    //     var data = table.get_data();
	// 	for (var i = 0; i < data.length; i++) {	
	// 		sales_order_item[i] =  data[i].item_code 
	// 		sales_order_code = data[i].against_sales_order
	// 	}
	...
	// 			against_sales_order:sales_order_code,
	// 			filters:
	// 			{
	// 				"From Date":frm.doc.from_date,
	// 				"To Date":frm.doc.to_date

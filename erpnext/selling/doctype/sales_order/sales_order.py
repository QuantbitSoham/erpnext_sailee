...
class SalesOrder(SellingController):
	...
	def press(self):
		...
		for row in self.items:
			name = (row.item_name,row.brand,row.item_code,row.description,row.gst_hsn_code,row.uom,row.rate,row.customer_item_code,row.delivery_date,row.price_list_rate,row.item_tax_template)
			if name in by_name: 
		...
		for (item_name,brand,item_code,description,gst_hsn_code,uom,rate,customer_item_code,delivery_date,price_list_rate,item_tax_template), data in by_name.items():

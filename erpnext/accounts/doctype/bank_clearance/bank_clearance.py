...
class BankClearance(Document):
	...
	def get_payment_entries(self):
		...
		for d in entries:
			...
			row.update(d)
		#--------  add custom code Pradip 	
		for m in self.get("payment_entries"):
			doc = frappe.get_all('Payment Entry',filters={'name':m.payment_entry},fields={'name','party_name'})
			for d in doc:
				m.party_name = d.party_name
		#-------------------------------------
